...
<h2>Forgot password</h2>
 ...
 <?php
              ...
              switch(@$_REQUEST['flg'])
                {
                case 1:
                echo '<div class="alert alert-danger alert-white rounded"><div class="icon"><i class="fa fa-times-circle"></i></div>
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                        
                        <strong>failed!</strong> user email does not  exists!
                        </div>';
                break;           
                case 2:
            ...
            <?php endif; ?>
              ...
              <form class="form-horizontal" action="<?php echo SITE_URL;?>change_password"  method="post">
                                      
                                        
                                        <div class="form-group">
                                          <label class="col-sm-5 control-label">EMAIL <span class="req-fld">*</span></label>
                                            <div class="col-sm-4">
                                              <input type="mail" class="form-control"  name="user_name" placeholder="mail "  title="five or more characters"  minlength="5" required maxlength="35">
                                            </div>
                                        </div>
                                     ...
                                     <!--   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          <div class="col-sm-offset-6 col-sm-5">
                                             <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-check"></i> Continue</button>&nbsp;
