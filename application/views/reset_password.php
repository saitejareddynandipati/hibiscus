...
<h2>Reset password</h2>
 ...
 <?php
            ...
            <?php endif; ?>
              ...
              <form class="form-horizontal" action="<?php echo SITE_URL;?>reset_pwd"  method="post">
                                      
                                        
                                        <div class="form-group">
                                          <label class="col-sm-5 control-label">Password <span class="req-fld">*</span></label>
                                            <div class="col-sm-4">
                                              <input type="text" class="form-control"  name="password" placeholder="password "    minlength="5" required maxlength="35">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <label class="col-sm-5 control-label">confirm password <span class="req-fld">*</span></label>
                                            <div class="col-sm-4">
                                              <input type="text" name="confirm_password"  placeholder="confirm password"  required class="form-control" >
                                            </div>
                                        </div>
                                     <!--   <div class="form-group">
                                          <label class="col-sm-5 control-label">Password <span class="req-fld">*</span></label>
